...
public class ParticipationRequestController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<ParticipationRequestDto> getAllByInitiator(
    ...
    public ParticipationRequestDto create(
            @PathVariable int userId, @RequestParam int eventId
    ) {
    ...
    public ParticipationRequestStatusUpdateResponseDto statusUpdate(
        ...
        ParticipationRequestStatusUpdateResponseDto.ParticipationRequestStatusUpdateResponseDtoBuilder<?, ?> responseBuilder
                = ParticipationRequestStatusUpdateResponseDto.builder();
        ParticipationRequestStatusUpdateRequestDto.ParticipationRequestStatusUpdateAction statusUpdateAction
                = participationRequestStatusUpdateRequestDto.getStatus();
        if (ParticipationRequestStatusUpdateRequestDto
                .ParticipationRequestStatusUpdateAction.CONFIRMED
        ...
        } else if (ParticipationRequestStatusUpdateRequestDto
                .ParticipationRequestStatusUpdateAction.REJECTED
                .equals(statusUpdateAction)
        ) {
